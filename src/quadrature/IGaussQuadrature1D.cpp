#include "IGaussQuadrature1D.h"
#include <iostream>

namespace nurbs
{
	double IGaussQuadrature1D::getImpl() const
	{
		return mGaussPts[ mCurrentGP ];
	}
	
	double IGaussQuadrature1D::getWeightImpl() const
	{
		return mGaussWts[ mCurrentGP ];
	}

	void IGaussQuadrature1D::initGaussPts( uint rule )
	{
		DoubleVec& pts = mGaussPts; // aliases for data member variables
		DoubleVec& wts = mGaussWts;
