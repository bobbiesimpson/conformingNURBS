                                        ...
                                        const uint p)
    {
        switch(p)
        {
            ...
            case 4:
                return
            {
                2.0 / 3.0 * (xi * xi - 1.0 / 4.0) * xi * (xi - 1.0),
                - 8.0 / 3.0 * (xi * xi - 1) * xi * (xi - 1.0 / 2.0),
                4.0 * (xi * xi - 1.0) * (xi * xi - 1.0 / 4.0),
                - 8.0 / 3.0 * (xi * xi - 1) * xi * (xi + 1.0 / 2.0),
                2.0 / 3.0 * (xi * xi - 1.0 / 4.0) * xi * (xi + 1.0)
            };
            default:
                                           ...
                                           const uint p)
    {
        switch(p)
        {
            ...
            case 4:
                return
            {
                (4.0 * pow(xi,2.0) * (xi - 1.0) )/3.0 + xi*((2.0 * pow(xi,2.0))/3.0 - 1.0/6.0) + ((2.0 * pow(xi,2.0))/3.0 - 1.0/6.0)*(xi - 1.0),
                - (16.0 * xi * xi * (xi - 1.0 / 2.0))/ 3.0 - xi * ((8.0 * xi * xi)/3.0 - 8.0/3.0) - ((8 * xi * xi )/ 3.0 - 8.0/3.0)*(xi - 1.0/2.0),
                8.0 * xi * ( xi * xi - 1.0/4.0) + 2.0 * xi * (4.0 * xi * xi - 4.0),
                - (16.0 * xi * xi * (xi + 1.0/2.0))/3.0 - xi*((8.0 * xi * xi)/3.0 - 8.0/3.0) - ((8.0 * xi * xi)/3.0 - 8.0/3.0)*(xi + 1.0/2.0),
                (4.0 * xi * xi * (xi + 1.0))/3.0 + xi * ((2.0 * xi * xi)/3.0 - 1.0/6.0) + ((2.0 * xi * xi)/3.0 - 1.0/6.0)*(xi + 1.0)
            };
