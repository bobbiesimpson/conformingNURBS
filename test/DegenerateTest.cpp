...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        //plot function on a degenerated element
        ...
        for(uint offset = 0; offset < 10; offset += 1)
        {
            ...
            ////            for(nurbs::IPolarIntegrate igpt_s(nurbs::GPt2D (1.0,1.0), sorder); !igpt_s.isDone(); ++igpt_s)
            //            for(nurbs::IElemIntegrate igpt_s(sorder); !igpt_s.isDone(); ++igpt_s)
            //            {
            //
